...
import { selectCartItems, selectCartTotal, selectCartItemCount, selectFinalTotal, selectCanCheckout } from '../../../features/cart/cartSelectors'
...
describe('Cart Selectors', () => {
  ...
  it('should return false for empty cart checkout', () => {
    const emptyState = { cart: { items: [], discountPercent: 0 } }
