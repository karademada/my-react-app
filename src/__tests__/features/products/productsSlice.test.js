...
import productsReducer, { setCategory, setPriceRange, setSearchQuery, clearFilters } from '../../../features/products/productsSlice'
...
describe('Products Slice', () => {
  ...
  it('should set price range filter', () => {
    const state = productsReducer(initialState, setPriceRange({ min: 100, max: 500 }))
